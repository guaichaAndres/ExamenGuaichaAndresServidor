...
a persistence unit "ExamenGuaichaAndresServidorPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "ExamenGuaichaAndresServidor\pom.xml":
...
artifact ("ExamenGuaichaAndresServidor.war") is already built. You can build
